...
PROMPT = "Explain what continuous batching is in one short paragraph."
MAX_NEW_TOKENS = 64
        ...
        async with client.stream(
            ...
            async for line in resp.aiter_lines():
                ...
                if "token" in payload:
                    ...
                    output_text_parts.append(payload["token"])
                    output_tokens += 1
...
async def main():
    ...
    print(f"NUM_REQUESTS={NUM_REQUESTS}, CONCURRENCY={CONCURRENCY}, MAX_NEW_TOKENS={MAX_NEW_TOKENS}")
